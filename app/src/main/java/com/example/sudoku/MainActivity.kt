...
class MainActivity : AppCompatActivity() {
    ...
    private fun boardInit(){
        ...
        if (board[0][0]==0) keys(selectedButton = binding.b11)

        binding.b12.text = if (board[0][1] == 0) "" else "${board[0][1]}"
        if (board[0][1]==0) keys(selectedButton = binding.b12)

        binding.b13.text = if (board[0][2] == 0) "" else "${board[0][2]}"
        if (board[0][2]==0) keys(selectedButton = binding.b13)

        binding.b14.text = if (board[1][0] == 0) "" else "${board[1][0]}"
        if (board[1][0]==0) keys(selectedButton = binding.b14)

        binding.b15.text = if (board[1][1] == 0) "" else "${board[1][1]}"
        if (board[1][1]==0) keys(selectedButton = binding.b15)

        binding.b16.text = if (board[1][2] == 0) "" else "${board[1][2]}"
        if (board[1][2]==0) keys(selectedButton = binding.b16)

        binding.b17.text = if (board[2][0] == 0) "" else "${board[2][0]}"
        if (board[2][0]==0) keys(selectedButton = binding.b17)

        binding.b18.text = if (board[2][1] == 0) "" else "${board[2][1]}"
        if (board[2][1]==0) keys(selectedButton = binding.b18)

        binding.b19.text = if (board[2][2] == 0) "" else "${board[2][2]}"
        if (board[2][2]==0) keys(selectedButton = binding.b19)

        //블록 1
        binding.b21.text = if (board[0][3] == 0) "" else "${board[0][3]}"
        if (board[0][3]==0) keys(selectedButton = binding.b21)

        binding.b22.text = if (board[0][4] == 0) "" else "${board[0][4]}"
        if (board[0][4]==0) keys(selectedButton = binding.b22)

        binding.b23.text = if (board[0][5] == 0) "" else "${board[0][5]}"
        if (board[0][5]==0) keys(selectedButton = binding.b23)

        binding.b24.text = if (board[1][4] == 0) "" else "${board[1][4]}"
        if (board[1][4]==0) keys(selectedButton = binding.b24)

        binding.b25.text = if (board[1][5] == 0) "" else "${board[1][5]}"
        if (board[1][5]==0) keys(selectedButton = binding.b25)

        binding.b26.text = if (board[1][6] == 0) "" else "${board[1][6]}"
        if (board[1][6]==0) keys(selectedButton = binding.b26)

        binding.b27.text = if (board[2][3] == 0) "" else "${board[2][3]}"
        if (board[2][3]==0) keys(selectedButton = binding.b27)

        binding.b28.text = if (board[2][4] == 0) "" else "${board[2][4]}"
        if (board[2][4]==0) keys(selectedButton = binding.b28)

        binding.b29.text = if (board[2][5] == 0) "" else "${board[2][5]}"
        if (board[2][5]==0) keys(selectedButton = binding.b29)
        // 블록 2
        binding.b31.text = if (board[0][6] == 0) "" else "${board[0][6]}"
        if (board[0][6]==0) keys(selectedButton = binding.b31)

        binding.b32.text = if (board[0][7] == 0) "" else "${board[0][7]}"
        if (board[0][7]==0) keys(selectedButton = binding.b32)

        binding.b33.text = if (board[0][8] == 0) "" else "${board[0][8]}"
        if (board[0][8]==0) keys(selectedButton = binding.b33)

        binding.b34.text = if (board[1][6] == 0) "" else "${board[1][6]}"
        if (board[1][6]==0) keys(selectedButton = binding.b34)

        binding.b35.text = if (board[1][7] == 0) "" else "${board[1][7]}"
        if (board[1][7]==0) keys(selectedButton = binding.b35)

        binding.b36.text = if (board[1][8] == 0) "" else "${board[1][8]}"
        if (board[1][8]==0) keys(selectedButton = binding.b36)

        binding.b37.text = if (board[2][6] == 0) "" else "${board[2][6]}"
        if (board[2][6]==0) keys(selectedButton = binding.b37)

        binding.b38.text = if (board[2][7] == 0) "" else "${board[2][7]}"
        if (board[2][7]==0) keys(selectedButton = binding.b38)

        binding.b39.text = if (board[2][8] == 0) "" else "${board[2][8]}"
        if (board[2][8]==0) keys(selectedButton = binding.b39)
// 블록 3
        binding.b41.text = if (board[3][0] == 0) "" else "${board[3][0]}"
        if (board[3][0] == 0) keys(selectedButton = binding.b41)

        binding.b42.text = if (board[3][1] == 0) "" else "${board[3][1]}"
        if (board[3][1] == 0) keys(selectedButton = binding.b42)

        binding.b43.text = if (board[3][2] == 0) "" else "${board[3][2]}"
        if (board[3][2] == 0) keys(selectedButton = binding.b43)

        binding.b44.text = if (board[4][0] == 0) "" else "${board[4][0]}"
        if (board[4][0] == 0) keys(selectedButton = binding.b44)

        binding.b45.text = if (board[4][1] == 0) "" else "${board[4][1]}"
        if (board[4][1] == 0) keys(selectedButton = binding.b45)

        binding.b46.text = if (board[4][2] == 0) "" else "${board[4][2]}"
        if (board[4][2] == 0) keys(selectedButton = binding.b46)

        binding.b47.text = if (board[5][0] == 0) "" else "${board[5][0]}"
        if (board[5][0] == 0) keys(selectedButton = binding.b47)

        binding.b48.text = if (board[5][1] == 0) "" else "${board[5][1]}"
        if (board[5][1] == 0) keys(selectedButton = binding.b48)

        binding.b49.text = if (board[5][2] == 0) "" else "${board[5][2]}"
        if (board[5][2] == 0) keys(selectedButton = binding.b49)
// 블록 4
        binding.b51.text = if (board[3][3] == 0) "" else "${board[3][3]}"
        if (board[3][3] == 0) keys(selectedButton = binding.b51)

        binding.b52.text = if (board[3][4] == 0) "" else "${board[3][4]}"
        if (board[3][4] == 0) keys(selectedButton = binding.b52)

        binding.b53.text = if (board[3][5] == 0) "" else "${board[3][5]}"
        if (board[3][5] == 0) keys(selectedButton = binding.b53)

        binding.b54.text = if (board[4][3] == 0) "" else "${board[4][3]}"
        if (board[4][3] == 0) keys(selectedButton = binding.b54)

        binding.b55.text = if (board[4][4] == 0) "" else "${board[4][4]}"
        if (board[4][4] == 0) keys(selectedButton = binding.b55)

        binding.b56.text = if (board[4][5] == 0) "" else "${board[4][5]}"
        if (board[4][5] == 0) keys(selectedButton = binding.b56)

        binding.b57.text = if (board[5][3] == 0) "" else "${board[5][3]}"
        if (board[5][3] == 0) keys(selectedButton = binding.b57)

        binding.b58.text = if (board[5][4] == 0) "" else "${board[5][4]}"
        if (board[5][4] == 0) keys(selectedButton = binding.b58)

        binding.b59.text = if (board[5][5] == 0) "" else "${board[5][5]}"
        if (board[5][5] == 0) keys(selectedButton = binding.b59)

        //블록 5
        binding.b61.text = if (board[3][6] == 0) "" else "${board[3][6]}"
        if (board[3][6] == 0) keys(selectedButton = binding.b61)

        binding.b62.text = if (board[3][7] == 0) "" else "${board[3][7]}"
        if (board[3][7] == 0) keys(selectedButton = binding.b62)

        binding.b63.text = if (board[3][8] == 0) "" else "${board[3][8]}"
        if (board[3][8] == 0) keys(selectedButton = binding.b63)

        binding.b64.text = if (board[4][6] == 0) "" else "${board[4][6]}"
        if (board[4][6] == 0) keys(selectedButton = binding.b64)

        binding.b65.text = if (board[4][7] == 0) "" else "${board[4][7]}"
        if (board[4][7] == 0) keys(selectedButton = binding.b65)

        binding.b66.text = if (board[4][8] == 0) "" else "${board[4][8]}"
        if (board[4][8] == 0) keys(selectedButton = binding.b66)

        binding.b67.text = if (board[5][6] == 0) "" else "${board[5][6]}"
        if (board[5][6] == 0) keys(selectedButton = binding.b67)

        binding.b68.text = if (board[5][7] == 0) "" else "${board[5][7]}"
        if (board[5][7] == 0) keys(selectedButton = binding.b68)

        binding.b69.text = if (board[5][8] == 0) "" else "${board[5][8]}"
        if (board[5][8] == 0) keys(selectedButton = binding.b69)
//블록 6
        binding.b71.text = if (board[6][0] == 0) "" else "${board[6][0]}"
        if (board[6][0] == 0) keys(selectedButton = binding.b71)

        binding.b72.text = if (board[6][1] == 0) "" else "${board[6][1]}"
        if (board[6][1] == 0) keys(selectedButton = binding.b72)

        binding.b73.text = if (board[6][2] == 0) "" else "${board[6][2]}"
        if (board[6][2] == 0) keys(selectedButton = binding.b73)

        binding.b74.text = if (board[7][0] == 0) "" else "${board[7][0]}"
        if (board[7][0] == 0) keys(selectedButton = binding.b74)

        binding.b75.text = if (board[7][1] == 0) "" else "${board[7][1]}"
        if (board[7][1] == 0) keys(selectedButton = binding.b75)

        binding.b76.text = if (board[7][2] == 0) "" else "${board[7][2]}"
        if (board[7][2] == 0) keys(selectedButton = binding.b76)

        binding.b77.text = if (board[8][0] == 0) "" else "${board[8][0]}"
        if (board[8][0] == 0) keys(selectedButton = binding.b77)

        binding.b78.text = if (board[8][1] == 0) "" else "${board[8][1]}"
        if (board[8][1] == 0) keys(selectedButton = binding.b78)

        binding.b79.text = if (board[8][2] == 0) "" else "${board[8][2]}"
        if (board[8][2] == 0) keys(selectedButton = binding.b79)

        //블록 7
        binding.b81.text = if (board[6][3] == 0) "" else "${board[6][3]}"
        if (board[6][3] == 0) keys(selectedButton = binding.b81)

        binding.b82.text = if (board[6][4] == 0) "" else "${board[6][4]}"
        if (board[6][4] == 0) keys(selectedButton = binding.b82)

        binding.b83.text = if (board[6][5] == 0) "" else "${board[6][5]}"
        if (board[6][5] == 0) keys(selectedButton = binding.b83)

        binding.b84.text = if (board[7][3] == 0) "" else "${board[7][3]}"
        if (board[7][3] == 0) keys(selectedButton = binding.b84)

        binding.b85.text = if (board[7][4] == 0) "" else "${board[7][4]}"
        if (board[7][4] == 0) keys(selectedButton = binding.b85)

        binding.b86.text = if (board[7][5] == 0) "" else "${board[7][5]}"
        if (board[7][5] == 0) keys(selectedButton = binding.b86)

        binding.b87.text = if (board[8][3] == 0) "" else "${board[8][3]}"
        if (board[8][3] == 0) keys(selectedButton = binding.b87)

        binding.b88.text = if (board[8][4] == 0) "" else "${board[8][4]}"
        if (board[8][4] == 0) keys(selectedButton = binding.b88)

        binding.b89.text = if (board[8][5] == 0) "" else "${board[8][5]}"
        if (board[8][5] == 0) keys(selectedButton = binding.b89)
        //블록 8
        binding.b91.text = if (board[6][6] == 0) "" else "${board[6][6]}"
        if (board[6][6] == 0) keys(selectedButton = binding.b91)

        binding.b92.text = if (board[6][7] == 0) "" else "${board[6][7]}"
        if (board[6][7] == 0) keys(selectedButton = binding.b92)

        binding.b93.text = if (board[6][8] == 0) "" else "${board[6][8]}"
        if (board[6][8] == 0) keys(selectedButton = binding.b93)

        binding.b94.text = if (board[7][6] == 0) "" else "${board[7][6]}"
        if (board[7][6] == 0) keys(selectedButton = binding.b94)

        binding.b95.text = if (board[7][7] == 0) "" else "${board[7][7]}"
        if (board[7][7] == 0) keys(selectedButton = binding.b95)

        binding.b96.text = if (board[7][8] == 0) "" else "${board[7][8]}"
        if (board[7][8] == 0) keys(selectedButton = binding.b96)

        binding.b97.text = if (board[8][6] == 0) "" else "${board[8][6]}"
        if (board[8][6] == 0) keys(selectedButton = binding.b97)

        binding.b98.text = if (board[8][7] == 0) "" else "${board[8][7]}"
        if (board[8][7] == 0) keys(selectedButton = binding.b98)

        binding.b99.text = if (board[8][8] == 0) "" else "${board[8][8]}"
        if (board[8][8] == 0) keys(selectedButton = binding.b99)
        //블록 9
    }
